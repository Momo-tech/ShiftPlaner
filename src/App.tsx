...
import { OrganizationContext, UserContext } from 'util/context';
import './colors.scss';
...
import { getAllUsersForComapny, getUser } from './supabase/userFunctions';
  ...
  return (
    <BrowserRouter>
      <UserContext.Provider value={user}>
        <OrganizationContext.Provider value={{ users }}>
          <SideNavbar>
            <MantineProvider
              theme={{
                colors: {
